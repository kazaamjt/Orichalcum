...
Token Lexer::scan_identifier(const std::string &identifier, Index index) {
	...
	else if (identifier == "False") token_type = TOKEN_TYPE::FALSE_;
	...
	else if (identifier == "in") token_type = TOKEN_TYPE::IN_;
	else if (identifier == "is") token_type = TOKEN_TYPE::IS_;
	...
	else if (identifier == "True") token_type = TOKEN_TYPE::TRUE_;
