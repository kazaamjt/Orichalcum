...
inline LibOrichalcum::CompilerOptions init_options(int argc, char *argv[]) {
	...
	options.add_options()
		...
		("debug", "Enables general use of Log::debug().")
		...
		("allow-stdout", "Enables print functionality at compile time.")
	...
	if (result.count("version")) {
		std::cout << "Orichalcum " << LibOrichalcum::VERSION << std::endl;
		exit(0);
	}
	...
	if (result.count("allow-stdout")) {
		compiler_options.allow_stdout = true;
	}
